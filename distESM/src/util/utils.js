 ...
 */
export const trim = function (inputString) {
    if (inputString.trim) {
 ...
 */
export const deepEquals = (objA, objB) => {
    if (objA === objB) {
        return true;
    }
 ...
 */
export const parseUrl = (initialURl, defaultPath) => {
    let url = initialURl;
 ...
 */
export const normalizeSetArguments = (args, startIndex = 0) => {
    let result;
