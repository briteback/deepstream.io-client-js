...
export declare type SocketFactory = (url: string, options: object, internalEmitter: any) => Socket;
...
export declare const socketFactory: (url: string, options: any, internalEmitter: any) => Socket;
